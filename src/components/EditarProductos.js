import { Form, Badge, Row, Col, Container, Card, Table, Button, InputGroup, Dropdown } from "react-bootstrap";
                    ...
                    <Row>
                                    ...
                                    <div class="row row-cols-1 row-cols-sm-1 row-cols-md-1 g-3">
                                        <div class="col">
                                            <div class="card shadow-sm">
                                                ...
                                                <div class="card-body">
                                                    <h6 style={{ color: "black" }} class="card-text align-items-center d-flex justify-content-center">
                                                        Imagen
                                                    </h6>
                        ...
                        <Col sm={9}>
                            <div className="py-5 bg-light">
                                ...
                                <Container style={{ paddingTop: "1.5%", paddingBottom: "1.5%" }}>
